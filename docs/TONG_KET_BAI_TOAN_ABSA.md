...
## 12. Vì sao Restaurant tốt hơn Laptop?

### 12.1. Restaurant có nhiều dữ liệu hơn
...
### 12.2. Laptop có tỷ lệ unseen aspect cao hơn
...
### 12.3. Aspect Laptop phân tán hơn
...
### 12.4. Phân phối Laptop thay đổi giữa train và test
...
- Thực nghiệm trên hai miền giúp kiểm tra khả năng áp dụng của pipeline.
...
- Mới đánh giá trên dữ liệu tiếng Anh thuộc hai miền; chưa chứng minh khả năng tổng quát sang ngôn ngữ hoặc lĩnh vực khác.
...
Đề tài đã xây dựng được pipeline phân tích cảm xúc theo khía cạnh trên hai miền Restaurant và Laptop. Kết quả chứng minh rằng aspect attention phù hợp với ABSA hơn biểu diễn CLS thuần vì mô hình có thể tập trung vào ngữ cảnh liên quan trực tiếp đến aspect.
